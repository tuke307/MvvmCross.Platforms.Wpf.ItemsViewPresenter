...
namespace Mvx.Wpf.ItemsPresenter.Commands
{
    /// <summary>
    ...
    /// cref="MvxWpfPresenter.CloseViewCommand" /> instead, the class behavior is
    ...
    /// the last view inside the navigation stack.
    /// </para>
    /// <para>
    /// If there is no views remaining in the navigation stack, the holder will be removed
    /// from the container.
    /// </para>
    /// </remarks>
    public class MvxCloseViewCommand : MvvmCross.Commands.IMvxCommand
    {
        ...
        public void Execute(object parameter)
        {
            ...
            var nav = MvvmCross.Mvx.IoCProvider.Resolve<MvvmCross.Navigation.IMvxNavigationService>();
